...
public abstract class Binding<T> implements Provider<T>, MembersInjector<T> {
  public static final Binding<Object> UNRESOLVED = new Binding<Object>(null, null, null, false, null) {
  ...
  protected Binding(String provideKey, String membersKey, String adapterKey, boolean singleton, Object requiredBy) {
